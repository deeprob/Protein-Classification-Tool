...
if __name__ == '__main__':
    ...
    create_features.create_possum_features(possum_interpreter_loc, possum_script_loc)
    ...
    obj = run_model.get_te(train_enz_file, None, label_file, train_feat_vecs,  None, 10, 'SVM', False)
